...
export const metadata: Metadata = {
  title: "Nexus Forge",
  description:
    "A Next.js starter template with nextjs and Lucia auth. Includes Prisma, tRPC, React-Email, TailwindCSS and shadcn-ui",
};
...
const features = [
  ...
  {
    name: "Database",
    description: "Prisma ORM with Postgres",
    logo: PrismaLogo,
  },
  {
  ...
  {
    name: "S3",
    description: "Store and serve static files with S3",
    logo: S3,
  }
];
